# Built-in agent: `statusline-setup`

> Extracted from the Claude Code binary (`v2.1.197`). Baked into the executable. `getSystemPrompt` is a plain inline template (no runtime interpolation).
